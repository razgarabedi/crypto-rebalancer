...
import { ArrowLeft, Shield, Lock, Key, AlertTriangle } from 'lucide-react';

export const metadata = {
  title: 'Security - Crypto Portfolio Rebalancer',
  description: 'Security practices and information for Crypto Portfolio Rebalancer',
};
